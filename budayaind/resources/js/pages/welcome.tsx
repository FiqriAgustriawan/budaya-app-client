            ...
            <div className="min-h-screen relative overflow-hidden transition-all duration-500">
                ...
                <main className="relative z-10 w-full max-w-7xl mx-auto px-6 lg:px-8 py-12 lg:py-20">
                    ...
                    <div className="text-center space-y-12">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
                            <div className={`backdrop-blur-xl rounded-2xl p-6 border shadow-lg hover:shadow-xl transition-all duration-300 ${
                                isDarkMode
                        ...
                        <div className="flex flex-col sm:flex-row gap-6 justify-center items-center pt-8">
                            {!auth.user ? (
                                <>
                                    ...
                                    <Link
                                        href={route('login')}
                                        className={`group px-10 py-5 backdrop-blur-sm rounded-2xl font-semibold text-lg transition-all duration-300 border shadow-lg hover:shadow-xl ${
                                            isDarkMode
                        ...
                        <div className="relative max-w-6xl mx-auto">
                            <div className={`absolute top-0 left-1/4 w-20 h-20 backdrop-blur-xl rounded-2xl flex items-center justify-center group hover:scale-110 transition-transform duration-300 animate-float border shadow-lg ${
                                isDarkMode
                                    ? 'border-gray-600/50 bg-gray-800/20'
                                    : 'border-gray-300/50 bg-white/20'
                            }`}>
                            ...
                            <div className={`absolute top-0 right-1/4 w-20 h-20 backdrop-blur-xl rounded-2xl flex items-center justify-center group hover:scale-110 transition-transform duration-300 animate-float delay-1000 border shadow-lg ${
                                isDarkMode
                                    ? 'border-gray-600/50 bg-gray-800/20'
                                    : 'border-gray-300/50 bg-white/20'
                            }`}>
                            ...
                            <div className={`absolute top-1/2 left-0 transform -translate-y-1/2 w-16 h-16 backdrop-blur-xl rounded-2xl flex items-center justify-center group hover:scale-110 transition-transform duration-300 animate-float delay-2000 border shadow-lg ${
                                isDarkMode
                                    ? 'border-gray-600/50 bg-gray-800/20'
                                    : 'border-gray-300/50 bg-white/20'
                            }`}>
                            ...
                            <div className={`absolute top-1/2 right-0 transform -translate-y-1/2 w-16 h-16 backdrop-blur-xl rounded-2xl flex items-center justify-center group hover:scale-110 transition-transform duration-300 animate-float delay-500 border shadow-lg ${
                                isDarkMode
                                    ? 'border-gray-600/50 bg-gray-800/20'
                                    : 'border-gray-300/50 bg-white/20'
                            }`}>
                ...
                <section className="relative z-10 w-full max-w-7xl mx-auto px-6 lg:px-8 py-20">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                        {/* Feature 1 */}
                        <div className={`group backdrop-blur-xl rounded-2xl p-6 hover:border-[#a4773e]/50 transition-all duration-300 hover:transform hover:scale-105 border shadow-lg hover:shadow-xl ${
                            isDarkMode
                                ? 'border-gray-600/50 bg-gray-800/20'
                                : 'border-gray-300/50 bg-white/20'
                        }`}>
                        ...
                        {/* Feature 2 */}
                        <div className={`group backdrop-blur-xl rounded-2xl p-6 hover:border-cyan-500/50 transition-all duration-300 hover:transform hover:scale-105 border shadow-lg hover:shadow-xl ${
                            isDarkMode
                                ? 'border-gray-600/50 bg-gray-800/20'
                                : 'border-gray-300/50 bg-white/20'
                        }`}>
                        ...
                        {/* Feature 3 */}
                        <div className={`group backdrop-blur-xl rounded-2xl p-6 hover:border-purple-500/50 transition-all duration-300 hover:transform hover:scale-105 cursor-pointer border shadow-lg hover:shadow-xl ${
                            isDarkMode
                                ? 'border-gray-600/50 bg-gray-800/20'
                                : 'border-gray-300/50 bg-white/20'
                        }`}
                        ...
                        {/* Feature 4 */}
                        <div className={`group backdrop-blur-xl rounded-2xl p-6 hover:border-green-500/50 transition-all duration-300 hover:transform hover:scale-105 border shadow-lg hover:shadow-xl ${
                            isDarkMode
                                ? 'border-gray-600/50 bg-gray-800/20'
                                : 'border-gray-300/50 bg-white/20'
                        }`}>
                ...
                {/* Footer */}
                <footer className={`relative z-10 backdrop-blur-xl border-t shadow-lg ${
                    isDarkMode
                        ? 'border-gray-600/50 bg-gray-800/20'
                        : 'border-gray-300/50 bg-white/20'
                }`}>
